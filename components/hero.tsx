  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold tracking-tight mb-8 text-balance animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200 uppercase leading-tight">
          {dict.hero.title}
        </h1>
