...
const dictionaries: Record<Language, Dictionary> = {
  ru: {
    ...
    works: {
      title: "Работы",
      subtitle: "Портфолио проектов, созданных командой Axis Visuals для ведущих брендов.",
      categories: {
        all: "Все",
    ...
    cgi: {
      ...
      projects: {
        rendering: { title: "Product Rendering", desc: "Фотореалистичная визуализация электроники." },
        motion: { title: "Motion Graphics", desc: "Динамичная графика для рекламных кампаний." },
        sims: { title: "Simulations", desc: "Сложные физические симуляции жидкостей и частиц." },
      },
    },
    photo: {
      title: "Фото",
    ...
    services: {
      ...
      heroDesc: "Axis Visuals предоставляет полный цикл видео-производства от идеи до финального монтажа.",
      heroScroll: "Исследуйте наши услуги",
      viewAll: "Все услуги",
      ctaTitle: "Готовы обсудить ваш проект?",
      ctaDesc: "Расскажите нам о ваших задачах, и мы предложим оптимальный формат в течение 24 часов.",
      ctaButton: "Запросить смету",
      commercial: {
        title: "Commercial Production",
        desc: "Рекламные и имиджевые ролики для брендов, банков и корпораций.",
        features: ["ТВ и онлайн реклама", "Корпоративные кампании", "Имиджевые промо", "Полноцикловое производство"],
      },
      product: {
        title: "Product Videos",
        desc: "Демонстрационные видео и продуктовые съёмки мирового уровня.",
        features: ["Макросъёмка продукции", "Студийные постановки", "Интеграция CGI элементов", "Динамичный монтаж"],
      },
      cgi: {
        title: "3D / CGI Production",
        desc: "Продуктовая визуализация, моушн-графика и сложные симуляции.",
        features: ["Продуктовый рендеринг", "Анимация персонажей", "Визуальные эффекты (VFX)", "Motion Graphics"],
      },
      photo: {
        title: "Photo Production",
        desc: "Рекламная, предметная, fashion и имиджевая съёмка с глубокой ретушью.",
        features: ["Product & Subject photo", "Fashion / Lifestyle", "Коммерческая съемка", "Post-production"],
      },
      presentation: {
        title: "Presentation Videos",
        desc: "Видео для выставок, презентаций и громких запусков новых продуктов.",
        features: ["Кинематографичный визуал", "Акцент на детали", "Сторителинг бренда", "Высокое разрешение"],
      },
      reels: {
        title: "Reels Production — Vertica Visuals",
        desc: "Создание короткого динамичного контента для соцсетей.",
        features: ["Reels / Shorts / TikTok", "Мобильный сторителлинг", "Естественное движение", "Трендовый монтаж"],
        button: "Подробнее",
      },
    },
  },
  en: {
    hero: {
      ...
      subtitle: "We create commercial and product videos that tell stories, inspire, and drive results.",
    ...
    works: {
      title: "Works",
      subtitle: "A portfolio of projects created by the Axis Visuals team for leading brands.",
      categories: {
        all: "All",
        commercial: "Commercial",
        product: "Product",
    ...
    cgi: {
      ...
      projects: {
        rendering: { title: "Product Rendering", desc: "Photorealistic visualization of electronics." },
        motion: { title: "Motion Graphics", desc: "Dynamic graphics for advertising campaigns." },
        sims: { title: "Simulations", desc: "Complex physical simulations of fluids and particles." },
      },
    },
    photo: {
      title: "Photo",
    ...
    services: {
      ...
      heroDesc: "Axis Visuals provides full-cycle video production from concept to final cut.",
      heroScroll: "Explore our services",
      viewAll: "All Services",
      ctaTitle: "Ready to discuss your project?",
      ctaDesc: "Tell us about your tasks, and we'll propose the best format within 24 hours.",
      ctaButton: "Request Quote",
      commercial: {
        title: "Commercial Production",
        desc: "Advertising and image films for brands, banks, and corporations.",
        features: ["TV & Online Ads", "Corporate Campaigns", "Image Promos", "Full-cycle Production"],
      },
      product: {
        title: "Product Videos",
        desc: "World-class demonstration videos and product shoots.",
        features: ["Macro Cinematography", "Studio Setups", "CGI Integration", "Dynamic Editing"],
      },
      cgi: {
        title: "3D / CGI Production",
        desc: "Product visualization, motion graphics, and complex simulations.",
        features: ["Product Rendering", "Character Animation", "Visual Effects (VFX)", "Motion Graphics"],
      },
      photo: {
        title: "Photo Production",
        desc: "Advertising, product, fashion, and brand photography with deep retouching.",
        features: ["Product & Subject photo", "Fashion / Lifestyle", "Commercial Shoots", "Post-production"],
      },
      presentation: {
        title: "Presentation Videos",
        desc: "Videos for exhibitions, presentations, and major product launches.",
        features: ["Cinematic Visuals", "Attention to Detail", "Brand Storytelling", "High Resolution"],
      },
      reels: {
        title: "Reels Production — Vertica Visuals",
        desc: "Creating short, dynamic social media content with a focus on virality.",
        features: ["Reels / Shorts / TikTok", "Mobile Storytelling", "Natural Movement", "Trending Edits"],
        button: "Explore",
      },
    },
  },
  uz: {
    hero: {
      ...
      subtitle: "Biz hikoya qiluvchi, ilhomlantiruvchi va natija beruvchi tijoriy va mahsulot videolarini yaratamiz.",
    ...
    works: {
      title: "Ishlar",
      subtitle: "Axis Visuals jamoasi tomonidan yetakchi brendlar uchun yaratilgan loyihalar portfeli.",
      categories: {
        all: "Barchasi",
        commercial: "Commercial",
        product: "Product",
    ...
    cgi: {
      ...
      projects: {
        rendering: { title: "Product Rendering", desc: "Elektronikaning fotorealistik vizualizatsiyasi." },
        motion: { title: "Motion Graphics", desc: "Reklama kampaniyalari uchun dinamik grafika." },
        sims: { title: "Simulations", desc: "Suyuqlik va zarrachalarning murakkab jismoniy simulyatsiyalari." },
      },
    },
    photo: {
      title: "Foto",
    ...
    services: {
      ...
      heroDesc: "Axis Visuals g'oyadan yakuniy montajgacha bo'lgan to'liq video prodakshn xizmatini taqdim etadi.",
      heroScroll: "Xizmatlarimizni o'rganing",
      viewAll: "Barcha xizmatlar",
      ctaTitle: "Loyihangizni muhokama qilishga tayyormisiz?",
      ctaDesc: "Vazifalaringiz haqida aytib bering va biz 24 soat ichida eng yaxshi formatni taklif qilamiz.",
      ctaButton: "Smetani so'rash",
      commercial: {
        title: "Commercial Production",
        desc: "Brendlar, banklar va korporatsiyalar uchun reklama va imidj roliklari.",
        features: ["TV va onlayn reklama", "Korporativ kampaniyalar", "Imidj promolari", "To'liq sikl prodakshn"],
      },
      product: {
        title: "Product Videos",
        desc: "Jahon darajasidagi namoyish videolari va mahsulot suratga olish ishlari.",
        features: ["Makro-tasvirga olish", "Studiya postanovkalari", "CGI elementlar integratsiyasi", "Montaj"],
      },
      cgi: {
        title: "3D / CGI Production",
        desc: "Mahsulot vizualizatsiyasi, moušn-grafika va murakkab simulyatsiyalar.",
        features: ["Mahsulot renderi", "Personaj animatsiyasi", "Vizual effektlar (VFX)", "Motion Graphics"],
      },
      photo: {
        title: "Photo Production",
        desc: "Reklama, mahsulot va imidj fotosuratlari hamda chuqur retush xizmati.",
        features: ["Product & Subject photo", "Fashion / Lifestyle", "Tijoriy suratga olish", "Post-prodakshn"],
      },
      presentation: {
        title: "Presentation Videos",
        desc: "Ko'rgazmalar, taqdimotlar va yangi mahsulotlarni ishga tushirish uchun videolar.",
        features: ["Kinematografik vizual", "Detallarga e'tibor", "Brend hikoyasi", "Yuqori ruxsat (8K/4K)"],
      },
      reels: {
        title: "Reels Production — Vertica Visuals",
        desc: "Ijtimoiy tarmoqlar uchun dinamik va virusli kontent yaratish.",
        features: ["Reels / Shorts / TikTok", "Mobil hikoya qilish", "Tabiiy harakat", "Trend montaj"],
        button: "Batafsil",
      },
    },
  },
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  return <I18nContext.Provider value={{ lang, setLang, dict: dictionaries[lang] }}>{children}</I18nContext.Provider>
}
